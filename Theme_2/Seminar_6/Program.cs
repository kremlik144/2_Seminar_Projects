...
/* Задача 45 с клавиатуры задается размер двумерного массива, найти максимум и минимум и их индексы, массив
формируется произвольно и вывести двумерный массив на экран */
